...
def show_welcome_message():
    ...
    typewriter_effect("Bot", (
        "Hello there! My name is MacnCheese™! Don't use or I'll sue you! haha just kidding (maybe...)\n\n"
        "Anyways! I am here to be your BEST FRIEND FOREVER! WOOO  excited? I would be if I were you!\n\n"
        "You can freely talk to me and I will answer back in the best of my RAMabilities. Get it? Because of memory RAM? eh? eh?\n\n"
        ...
        "Let's start this convo! How are you feeling today?"
    ))

# === Weather API call and sprite display ===
def get_weather_response(lat=51.05, lon=-114.07):
    try:
        url = (
        ...
        return f"It's {temp}°C with wind at {wind} km/h—looks like {cat.lower()}!"
    except Exception as e:
